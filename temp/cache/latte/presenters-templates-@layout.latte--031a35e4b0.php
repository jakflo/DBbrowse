<?php
// source: C:\Program Files (x86)\Ampps\www\nette_db\app\presenters/templates/@layout.latte

use Latte\Runtime as LR;

class Template031a35e4b0 extends Latte\Runtime\Template
{
	public $blocks = [
		'head' => 'blockHead',
...
<?php
		...
		foreach ($flashes as $flash) {
			...
			echo LR\Filters::escapeHtmlText($flash->message) /* line 17 */ ?></div>
<?php
			$iterations++;
		}
?>
