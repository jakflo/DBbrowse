<?php
// source: C:\Program Files (x86)\Ampps\www\nette_db\app/config/config.neon 
// source: C:\Program Files (x86)\Ampps\www\nette_db\app/config/config.local.neon 

class Container_cbc961af02 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\DbtPresenter' => [1 => ['application.1']],
		...
		'services' => [
			...
			'application.1' => 'App\Presenters\DbtPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\Program Files (x86)\Ampps\www\nette_db\app',
			'wwwDir' => 'C:\Program Files (x86)\Ampps\www\nette_db\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\Program Files (x86)\Ampps\www\nette_db\app/../temp',
		];
	}
	...
	/**
	 * @return App\Presenters\DbtPresenter
	 */
	public function createServiceApplication__1()
	{
		$service = new App\Presenters\DbtPresenter;
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Program Files (x86)\Ampps\www\nette_db\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Program Files (x86)\Ampps\www\nette_db\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Program Files (x86)\Ampps\www\nette_db\app/../temp/cache',
	...
	{
		return new Container_cbc961af02_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_cbc961af02_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_cbc961af02 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\Program Files (x86)\Ampps\www\nette_db\app/../temp/cache/latte');
